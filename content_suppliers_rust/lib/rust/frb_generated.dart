...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1122641696;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<List<String>> crateApiLoadMangaPages({
    required String supplier,
    required String id,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiAvalaibleSuppliersConstMeta =>
      const TaskConstMeta(debugName: "avalaible_suppliers", argNames: []);
  ...
  TaskConstMeta get kCrateApiGetChannelsConstMeta =>
      const TaskConstMeta(debugName: "get_channels", argNames: ["supplier"]);
  ...
  Future<List<String>> crateApiLoadMangaPages({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiLoadMangaPagesConstMeta,
  ...
  TaskConstMeta get kCrateApiLoadMangaPagesConstMeta => const TaskConstMeta(
    debugName: "load_manga_pages",
  ...
  ContentMediaItem dco_decode_content_media_item(dynamic raw) {
    ...
    return ContentMediaItem(
      title: dco_decode_String(arr[0]),
      section: dco_decode_opt_String(arr[1]),
      image: dco_decode_opt_String(arr[2]),
      sources: dco_decode_opt_list_content_media_item_source(arr[3]),
    ...
    switch (raw[0]) {
      case 0:
        return ContentMediaItemSource_Video(
          ...
          hlsProxy: dco_decode_bool(raw[4]),
        );
      case 1:
      ...
      case 2:
        return ContentMediaItemSource_Manga(
          ...
          headers: dco_decode_opt_Map_String_String_None(raw[2]),
  ...
  ContentMediaItem sse_decode_content_media_item(SseDeserializer deserializer) {
    ...
    var var_sources = sse_decode_opt_list_content_media_item_source(
      deserializer,
    );
    var var_params = sse_decode_list_String(deserializer);
    return ContentMediaItem(
  ...
  ContentMediaItemSource sse_decode_content_media_item_source(
    ...
    switch (tag_) {
      case 0:
        ...
        var var_hlsProxy = sse_decode_bool(deserializer);
        return ContentMediaItemSource_Video(
          link: var_link,
          description: var_description,
          headers: var_headers,
          hlsProxy: var_hlsProxy,
        );
      case 1:
        var var_link = sse_decode_String(deserializer);
        var var_description = sse_decode_String(deserializer);
  ...
  void sse_encode_list_content_media_item_source(
    List<ContentMediaItemSource> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
